									...
									<div class="example">
										<ul class="list-group wd-md-100p users-list-group">
											<li class="list-group-item d-flex align-items-center">
												...
												<div>
													<h6 class="tx-15 mb-1 tx-inverse tx-semibold mg-b-0">Adrian Monino</h6><span class="d-block tx-13 text-muted">Pro</span>
												</div>
											...
											<li class="list-group-item d-flex align-items-center">
												...
												<div>
													<h6 class="tx-15 mb-1 tx-inverse tx-semibold mg-b-0">Joel Mendez</h6><span class="d-block tx-13 text-muted">Pro</span>
												</div>
												<div class="d-flex float-right mr-auto">
													<a href="#" class="btn btn-outline-light btn-icon ml-2">
													  <div class=""><i class="bx bx-plus"></i></div>
											...
											<li class="list-group-item d-flex align-items-center">
												...
												<div>
													<h6 class="tx-15 mb-1 tx-inverse tx-semibold mg-b-0">Marianne Audrey</h6><span class="d-block tx-13 text-muted">Pro</span>
												</div>
												<div class="d-flex float-right mr-auto">
													<a href="#" class="btn btn-outline-light btn-icon ml-2">
													  <div class=""><i class="bx bx-plus"></i></div>
