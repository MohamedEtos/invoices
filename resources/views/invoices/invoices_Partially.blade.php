...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">الفواتير</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ الفواتير المدفوعه جزئياً</span>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="hidden" class="form-control" name="id_inv" id="id_inv" value="">
                                <input type="text"  class="form-control" name="invoices_number" id="invoices_number" value=''>
                        </div>
                        ...
                        <select name="invoices_status" id="invoices_status" class="custom-select my-1 mr-sm-2" required>
                                <option value="2" >مدفعوه كلياً</option>
