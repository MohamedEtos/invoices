					...
					<div class="col-xl-12">
						<div class="card">
							<div class="card-header pb-0">
								...
								<p class="tx-12 tx-gray-500 mb-2">Example of RetajTex Simple Table. <a href="">Learn more</a></p>
							</div>
							<div class="card-body">
					...
					<div class="col-xl-12">
						<div class="card">
							<div class="card-header pb-0">
								...
								<p class="tx-12 tx-gray-500 mb-2">Example of RetajTex Striped Rows.. <a href="">Learn more</a></p>
							</div>
							<div class="card-body">
								<div class="table-responsive">
					...
					<div class="col-xl-12">
						<div class="card mg-b-20">
							<div class="card-header pb-0">
								...
								<p class="tx-12 tx-gray-500 mb-2">Example of RetajTex Bordered Table.. <a href="">Learn more</a></p>
							</div>
							<div class="card-body">
								<div class="table-responsive">
					...
					<div class="col-xl-12">
						<div class="card">
							<div class="card-header pb-0">
								...
								<p class="tx-12 tx-gray-500 mb-2">Example of RetajTex Hoverable Rows Table.. <a href="">Learn more</a></p>
							</div>
							<div class="card-body">
